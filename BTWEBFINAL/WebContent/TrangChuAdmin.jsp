...
<body>
    ...
    <tr>
      <td>
        ...
        <div align="right">
          <a href="TrangDangNhap.jsp"><button class="btn btn-default" >Đăng Xuất</button></a>
        </div>
      </td>
    </tr>
    </table>
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="list-group" background-size="15px">
                            ...
                            <a href="ThongTinCaNhan.jsp" class="list-group-item"><img border="0" src="Image/user.png" width="24" height="24"> Thông tin cá nhân</a>
                             ...
                             <a href="QuanLyNguoiDung_Admin.jsp" class="list-group-item"><img border="0" src="Image/marks.gif" width="24" height="24"> Quản lý người dùng</a> 
                            <a href="QuanLyBieuMau_Admin.jsp" class="list-group-item"><img border="0" src="Image/marks.gif" width="24" height="24"> Quản lý biểu mẫu</a>                               
