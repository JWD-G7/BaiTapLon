  ...
  <tr style="background-color: #EFF3BF">
   ...
   <tr style="height: 30px; " >
      ...
      <a href="#dangky"><input class="btn btn-primary" style="width: 100px; height:35px; position: relative; left: 15%;" data-toggle="modal" data-target="#dangky" value="Đăng ký"/></a>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div align="center" class="modal-header">
                ...
                <button type="button" class="btn btn-primary" style="position: relative; left: 25%;">Đăng ký</button>
       ...
       <a href="#myModal"><button style="position: relative; left: 30%;" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Thêm đăng ký</button></a>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div align="center" class="modal-body">
                <p>Chọn nội dung hủy đăng ký&hellip;</p>
                <select>
