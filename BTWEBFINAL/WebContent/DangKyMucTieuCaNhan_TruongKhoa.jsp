...
<meta charset="utf-8">
      ...
      <title>Đăng Ký Mục Tiêu Cá Nhân Trưởng Khoa</title>
...
<body>
    ...
    <table border="0" width="1002" cellpadding="0" cellspacing="0" align="center">
     ...
     <table  style="position: relative; left: 200px;">
       ...
       <img border="0" src="Image/muctieu.png" width="24" height="24">
         <span style="color: lightblue" >ĐĂNG KÝ MỤC TIÊU CÁ NHÂN </span></td>
          </tr>      
       </tbody>
     </table>
     <br>
     <table style="position: relative; left: 100px;">
      <tr >
        ...
        <h3 align="center"><strong>PHIẾU GIẢNG VIÊN TỰ ĐÁNH GIÁ</strong></h3>
        </tr>
     </table>
     ...
     <tr style="background-color: lightblue;">
        ...
        <table style="width: 90%;">
          <tr>
            <td style="">
             <span style="position: relative; left: 20%;">A: Giảng viên</span>
             <!-- <span style="position: relative; left: 17%;">B: Trưởng Bộ Môn</span> -->
             <span style="position: relative; left: 60%;">B: Hiệu trưởng</span>
            </td>
          </tr>     
        </table> 
        ...
        <td width="25%" height="30">
          ...
          <tr>
            <td style="">
             <span style="position: relative; left: 30%;">A</span>
             <!-- <span style="position: relative; left: 45%;">B</span> -->
             <span style="position: relative; left: 65%;">B</span>
            </td>
          </tr>     
          </table>
   ...
   <tr style="height: 30px; " >
      ...
      <td height="50">    
        <a href="#dangky"><input class="btn btn-primary" style="width: 100px; height:35px; position: relative; left: 15%;" data-toggle="modal" data-target="#dangky" value="Đăng ký"/></a>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div align="center" class="modal-header">
                ...
                <h4 class="modal-title">Bạn có muốn đăng ký không?</h4>
              </div> <br>

                <button type="button" class="btn btn-primary" style="width: 100px; height:35px;position: relative; left: 25%;">Đăng ký</button>
       ...
       <a href="#myModal"><button style=" height:35px;position: relative; left: 30%;" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Thêm đăng ký</button></a>
       <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <a href="#huydangky"><button style="position: relative; left: 45%;" class="btn btn-primary" data-toggle="modal" data-target="#huydangky">Hủy đăng ký</button></a>
